...
- Generated Linux CI and the native macOS lane use Python 3.12.10, the highest stable 3.12 patch currently published for Darwin ARM64 by the setup-python distribution manifest; the shared exact pin prevents the generated and host workflows from drifting.
